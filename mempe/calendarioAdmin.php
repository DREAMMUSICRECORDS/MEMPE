    ...
    <div class="modal">
        ...
        <form class="form-grid" action="calendarioAdmin.php" method="POST">
            ...
            <div class="campo full">
                ...
                <textarea placeholder="Cuentanos sobre ti..." style="width:100%; border-radius:8px; border:1px solid #ddd; padding:10px;"></textarea>
            </div>
            <div class="acciones">
