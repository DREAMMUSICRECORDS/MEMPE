...
<div class="contenedor-auth">
    <div class="titulo-principal">
        ...
        <p>Tu companera de salud femenina</p>
    </div>

    <div class="card">
        <h3>Bienvenida</h3>
        <p class="subtitulo" id="texto-bienvenida">Inicia sesion para continuar</p>

        <div class="tabs-registro">
            <button class="tab-btn activo" id="btn-calendarioAdmin" onclick="mostrarTab('calendarioAdmin')">Iniciar Sesion</button>
